...
// Real structured-logging library: pino. Capture in-memory via a custom write
// stream, with base:null (no pid/hostname) and timestamp:false (no real time).
const log = pino({ base: null, timestamp: false, level: "info" }, stream);

log.info({ count: 5 }, "processed");
// Each captured JSON line: {"level":30,"count":5,"msg":"processed"}
